...
const registroVehiculo = async (req, res) => {
    try {
        ...
        const { foto_placa_vehiculo, foto_serial, foto_vehiculo,
            foto_licencia_conducir, foto_tarjeta_propiedad,
            foto_soat, foto_tecnomecanica } = req.files;

        if (!foto_placa_vehiculo || !foto_serial || !foto_vehiculo || !foto_licencia_conducir || !foto_tarjeta_propiedad || !foto_soat || !foto_tecnomecanica) {
